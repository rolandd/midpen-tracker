...
<div class="activity-list-container">
	...
	{:else if activities.length === 0}
		<EmptyState variant="compact" description="No activities found for this preserve." />
	{:else}
			...
			{#each activities as activity (activity.id)}
				<li>
					<a
						...
						target="_blank"
						rel="noopener"
						class="activity focus-visible:outline-2 focus-visible:outline-[var(--color-primary)] focus-visible:outline-offset-2"
