...
## 2024-05-18 - Vulnerable Dependency: quinn-proto
**Vulnerability:** The `quinn-proto` dependency (v0.11.13) had a known Denial of Service (DoS) vulnerability (RUSTSEC-2026-0037).
**Learning:** Outdated dependencies can introduce known security vulnerabilities into the application.
**Prevention:** Regularly run `cargo audit` in CI/CD pipelines to detect and update vulnerable dependencies.
